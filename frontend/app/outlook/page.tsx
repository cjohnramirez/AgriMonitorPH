      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-3">
          <Card className="p-5 bg-slate-900 border-slate-800 h-fit">
            ...
            <p className="text-sm text-slate-400">
              Long-term food security monitoring and climate adaptation.
            </p>
          </Card>
        </div>
        ...
        <div className="col-span-9 space-y-6">
          <div className="grid grid-cols-3 gap-4">
            <Card
              className={`p-5 bg-slate-900 border-slate-800 border-l-4 ${riskColorClass.replace("bg-", "border-l-")}`}
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <div
                  className={`w-2.5 h-2.5 rounded-full animate-pulse ${riskColorClass}`}
                />
              </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              <h2 className="text-xs font-bold text-slate-500 uppercase tracking-tighter">
                Production Forecast
              </h2>
                ...
                {forecasts.map((f, i) => (
                  <Card key={i} className="p-4 bg-slate-900 border-slate-800">
                    ...
                    <div className="flex items-baseline gap-2 mt-1">
                      ...
                      <span
                        className={`text-[10px] ${f.trend === "down" ? "text-red-500" : "text-slate-500"}`}
                      >
                        {f.change}
                      </span>
                    </div>
